...
# Inert while ogManual is true — kept here in case the card is ever regenerated.
ogSubtitle: "An open letter to UKRI on reforms to promote greater institutional diversity."
...
# Keep the hand-designed share card in public/og/ — `npm run og` skips this piece.
ogManual: true
