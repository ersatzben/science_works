...
const writing = defineCollection({
  ...
  schema: z.object({
    ...
    ogSubtitle: z.string().optional(),       // even shorter standfirst, used only on the share card (npm run og); falls back to shortSubtitle → subtitle (never summary)
    ...
    // The share card (public/og/<slug>.png) is generated by `npm run og`. Set
    // this to keep a hand-made card instead: the generator leaves the file alone.
    ogManual: z.boolean().default(false),
